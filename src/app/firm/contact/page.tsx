          ...
          <div className="space-y-6">
            <div className="rounded-2xl bg-gradient-to-br from-gray-900 via-gray-800 to-primary/70 text-white p-8 shadow-lg">
              ...
              <p className="text-sm text-white/80">
                Male, Maldives - our multidisciplinary team works across design,
                engineering, and research to deliver resilient, high-performance
                projects.
              </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
                ...
                <p className="text-gray-700 text-sm">9:00 AM - 5:00 PM (GMT+5)</p>
              </div>
              <div className="rounded-xl border border-gray-200 bg-gray-50 p-4">
                <p className="text-xs uppercase tracking-wide text-gray-500 font-semibold">
                  Connect
                ...
                <div className="mt-2 flex flex-wrap gap-3">
                  <a
                    href="tel:+9603315049"
                    className="inline-flex items-center gap-2 rounded-full bg-white px-3 py-2 text-sm font-semibold text-primary border border-primary/20 hover:border-primary hover:bg-primary/5 transition-colors"
                  >
                    <Phone className="h-4 w-4" />
                    Call
                  </a>
